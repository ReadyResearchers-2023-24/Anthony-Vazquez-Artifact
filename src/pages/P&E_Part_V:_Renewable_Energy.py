...
st.write(':blue[Run-of-River Hydropower]: In run-of-river systems, :blue[water flows naturally] downstream without significant storage or regulation. :blue[Turbines] are installed directly in the :blue[river] or :blue[stream] to capture :blue[kinetic energy] from the f:blue[lowing water].')
